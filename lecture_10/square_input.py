...
def square(*args):
    ...
    while _lt(_get('clock', local_vars, None)['clock'], _len(_get('number_', local_vars, None)['number_'])): 
        ...
        check_events()
        _set(to_key(_get('clock', local_vars, None)['clock']), local_vars, _get('number_', local_vars, None)['number_'])[to_key(_get('clock', local_vars, None)['clock'])] = _mul(_get(to_key(_get('clock', local_vars, None)['clock']), local_vars, _get('number_', local_vars, None)['number_'])[to_key(_get('clock', local_vars, None)['clock'])], _get(to_key(_get('clock', local_vars, None)['clock']), local_vars, _get('number_', local_vars, None)['number_'])[to_key(_get('clock', local_vars, None)['clock'])])
...
try:
    ...
    check_events()
    square(_get('number_', local_vars, None)['number_'])
